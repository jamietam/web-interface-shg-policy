				...
				for pacr in pacr_set:
					for pacb in pacb_set:
						for year in years_set:
							...
							cmd3 = "mv prevalences.csv "+dirscen+"prevalences_females_w%s_r%s_b%s_w%s_r%s_b%s_%s.csv" % scen
						...
						os.system("mv $(ls | grep results) home/jamietam/scenarios_parallel_%s/cleanairresults/" % iter1)
