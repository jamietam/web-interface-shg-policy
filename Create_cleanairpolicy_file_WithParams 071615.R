...
#     
#     initdeploy_b=paste(initdeploy_b,',',year,sep="")
#     cessdeploy_b=paste(cessdeploy_b,',',year,sep="")
#   }
#   
...
#   finalfile=rbind(filehead,baselinescenario)
  finalfile=rbind(filehead,policyscenario)

#   write.table(finalfile,paste0('inputscleanair_',(sexes[y]),'_w',Iwp,'_r',Ir,'_b',Ib,'_w',pacwp,'_r',pacr, '_b',pacb,'_',year,'.csv'),col.names=FALSE,row.names=FALSE,quote=FALSE,eol='\n')
#   write.table(policyscenario,paste0('inputscleanair_',(sexes[y]),'_w',Iwp,'_r',Ir,'_b',Ib,'_w',pacwp,'_r',pacr, '_b',pacb,'_',year,'.csv'),col.names=FALSE,row.names=FALSE,quote=FALSE,eol='',append='TRUE')
  write.table(finalfile,paste0('inputscleanair_',(sexes[y]),'_w',Iwp,'_r',Ir,'_b',Ib,'_w',pacwp,'_r',pacr, '_b',pacb,'_',year,'.csv'),col.names=FALSE,row.names=FALSE,quote=FALSE,eol='',append='TRUE')
