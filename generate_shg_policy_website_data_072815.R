...
for (i in 1:length(enactpolicy)){
  ...
  baselineM <- read.csv('cleanairresults/prevresults/baseline_males_prevalences.csv', header=TRUE)
  baselineF <- read.csv('cleanairresults/prevresults/baseline_females_prevalences.csv', header=TRUE)
