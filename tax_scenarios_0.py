...
dirresults = dirweb+'taxresults/'

initprice_set = [4,10] ### initial price per pack
tax_set = [0.00,0.50,1.00,2.00,3.00,4.00] ### federal tax increase
...
#			cmd2="mv prevalences.csv "+dirscen+"prevalences_males_%0.2f_t%0.2f_%s.csv" % scen
#			os.system(cmd2) 
...
#			cmd4="mv prevalences.csv "+dirscen+"prevalences_females_%0.2f_t%0.2f_%s.csv" % scen
#			os.system(cmd4) 
