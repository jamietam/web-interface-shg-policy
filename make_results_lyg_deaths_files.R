...
for (i in 1:length(enactpolicy)){
  ...
  baselineM <- read.csv(paste0('baseline_prevalences_males_',endingyear,'_',str(cohortsize),'.csv'), header=TRUE)
  baselineF <- read.csv(paste0('baseline_prevalences_females_',endingyear,'_',str(cohortsize),'.csv'), header=TRUE)
