...
for (i in 1:length(enactpolicy)){
  ...
  baselineM <- read.csv(paste0('baseline/baseline_prevalences_males_',endingyear,'_',format(cohortsize, scientific=FALSE),'.csv'), header=TRUE)
  baselineF <- read.csv(paste0('baseline/baseline_prevalences_females_',endingyear,'_',format(cohortsize, scientific=FALSE),'.csv'), header=TRUE)
