...
tobaccodeaths_males_current <- acm_males_current - acm_males_never
tobaccodeaths_males_former <- acm_males_former - acm_males_former

tobaccodeaths_females_current <- acm_females_current - acm_females_never 
tobaccodeaths_females_former <- acm_females_former - acm_females_never
