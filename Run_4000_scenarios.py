...
#dirscen = '/home/jamietam/scenarios' ## Directory contains 'Age_effects_male_cleanair_021815.csv', 'Age_effects_female_cleanair_021815.csv','Create_cleanairpolicy_file_WithParams.R ','generate_shg_$
...
dirscen = '/home/jamietam/scenarios_parallel_'+iter1+'/' ## Directory contains 'Age_effects_male_cleanair_021815.csv', 'Age_effects_female_cleanair_021$
...
pacwp_set = [1.0] ### percentage already covered by workplace clean air laws
pacr_set = [1.0] ### percentage already covered by restaurants clean air laws
pacb_set = [1.0] ### percentage already covered by bars clean air laws
years_set = [2015,2016,2018,2020] ## Year of policy implementation
