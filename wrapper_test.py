...
for j in xrange(numThreads):
   #cmd3 = "sudo python /home/jamietam/scenarios_parallel_%s/test_Run_4000_scenarios_test.py %s > /home/jamietam/test-%s 2>> /home/jamietam/std.out-test-%s &" % (str(j), str(j), str(j), str(j))
   ...
   cmd3 = cmd3+"/home/jamietam/test-%s 2>> /home/jamietam/std.out-test-%s &" % (str(j), str(j))
