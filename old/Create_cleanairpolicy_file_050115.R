...
pacwp=0.2  ### percentage already covered by workplace clean air laws
pacr=0.2   ### percentage already covered by restaurants clean air laws
pacb=0.2   ### percentage already covered by bars clean air laws
...
write.table(finalfile,'policies_20coverage.csv',col.names=FALSE,row.names=FALSE,quote=FALSE,eol='\n')
write.table(policyscenario,'policies_20coverage.csv',col.names=FALSE,row.names=FALSE,quote=FALSE,eol='',append='TRUE')
