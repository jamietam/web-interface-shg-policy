...
dirsim='/home/jamietam/shg-policy-module_parallel'+iter1+'_'+iter2+'/' # Directory contains 'policy_shg.py'
dirinputs=dirsim+'/inputs/' # Directory contains 'policies.csv' and 'demographics.csv'
dirscen = '/home/jamietam/scenarios_parallel'+iter1+'_'+iter2+'/' ## Directory contains 'Age_effects_male_cleanair_021815.csv', 'Age_effects_female_cleanair_021815.csv','Create_cleanairpolicy_file_WithParams.R ','generate_shg_policy_website_data.R', 'censuspop2010to2060.csv'
...
Iwp_set = [1,0] ### indicator of workplace policy to be implemented 1-yes, 0-no
				...
				for pacr in pacr_set:
					for pacb in pacb_set:
						for year in years_set:
							...
							os.system("mv prevalences.csv /home/jamietam/scenarios_parallel2/prevalences_females_w%s_r%s_b%s_w%s_r%s_b%s_%s.csv" % scen) # prevalences csv files (8 total) will be overwritten 
						...
						os.system("mv results_w%s_r%s_b%s_w%s_r%s_b%s.csv home/jamietam/scenarios_parallel2/cleanairresults/" % params)
						os.system("mv deaths_w%s_r%s_b%s_w%s_r%s_b%s.csv home/jamietam/scenarios_parallel2/cleanairresults/" % params)
						os.system("mv prevalences* /home/jamietam/scenarios_parallel2/cleanairresults/prevresults")
						count = count+1
