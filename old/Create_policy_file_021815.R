...
write.table(finalfile,'policies_test_021815.csv',col.names=FALSE,row.names=FALSE,quote=FALSE,eol='\n')
write.table(policyscenario,'policies_test_021815.csv',col.names=FALSE,row.names=FALSE,quote=FALSE,eol='',append='TRUE')
