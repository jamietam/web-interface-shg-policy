...
write.table(finalfile,paste0('inputscleanair_w',Iwp,'_r',Ir,'_b',Ib,'_w',pacwp,'_r',pacr, '_b',pacb,'_',year,'.csv'),col.names=FALSE,row.names=FALSE,quote=FALSE,eol='\n')
write.table(policyscenario,paste0('inputscleanair_w',Iwp,'_r',Ir,'_b',Ib,'_w',pacwp,'_r',pacr, '_b',pacb,'_',year,'.csv'),col.names=FALSE,row.names=FALSE,quote=FALSE,eol='',append='TRUE')
