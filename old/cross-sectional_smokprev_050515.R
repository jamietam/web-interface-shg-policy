...
men <- prevalencesM[prevalencesM$age<18,] # remove children
...
women <- prevalencesF[prevalencesF$age<18,]
...
#  ------------------------------------------------------------------------
pdf('SmokprevAnnual_nocoverage_0to17.pdf') ### CHECK FILE NAME
