...
#createdir = "cp -Tr /home/jamietam/shg-policy-module_parallel/ /home/jamietam/shg-policy-module_parallel_%s &" % (str(iter1))
#os.system(createdir)
#time.sleep(30)
...
dirweb = '/home/jamietam/web-interface-shg-policy/'## Directory contains 'Age_effects_male_cleanair_021815.csv', 'Age_effects_female_cleanai$
dirresults = '/home/jamietam/tax_results/'

initprice_set = [4.50] ### initial price per pack
tax_set = [6.50] ### federal tax increase
