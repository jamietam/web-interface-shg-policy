...
# Do cumulative deaths 2020-2029, etc. 
...
getcumulativedeaths <- function(finalprevs,specifyyear){
  theseyearsonly <- finalprevs[finalprevs$year<=specifyyear,] 
...
createresultsfile <- function(population, popmales, popfemales, prevalencesM, prevalencesF, policy_year,agegroups,agegroupstart, agegroupend){
  ...
  for(row in 1:length(finalprevs$age)) { 
    finalprevs$cumulativedeathsM_baseline[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[1]
    finalprevs$cumulativedeathsM_policy[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[2]
    finalprevs$cumulativedeathsM_avoided[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[3]
    
    finalprevs$cumulativedeathsF_baseline[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[4]
    finalprevs$cumulativedeathsF_policy[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[5]
    finalprevs$cumulativedeathsF_avoided[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[6]
    
    finalprevs$cumulativedeaths_baseline[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[7]
    finalprevs$cumulativedeaths_policy[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[8]
    finalprevs$cumulativedeaths_avoided[row] <- getcumulativedeaths(finalprevs, finalprevs$year[row])[9]
  }
...
#       deaths_df <- rbind(deaths_df, gettobaccodeaths_agegroup(finalprevs,y,agegroupstart[x],agegroupend[x]))
      deaths_df <- rbind(deaths_df, rep(NA,18))
    }
    names(deaths_df)<- c("tobaccodeathsM_baseline", "tobaccodeathsM_policy", "deathsM_avoided", 
                         ...
                         "cumulativedeaths_baseline",	"cumulativedeaths_policy", "cumulativedeaths_avoided")  
...
colnames(finalprevs) <- c("year","age","cohort","males_baseline","females_baseline","males_policy","females_policy","totalprev_baseline","totalprev_policy",
               "cumulativedeathsM_baseline", "cumulativedeathsM_policy", "cumulativedeathsM_avoided",
               "cumulativedeathsF_baseline", "cumulativedeathsF_policy", "cumulativedeathsF_avoided",
               "cumulativedeaths_baseline", "cumulativedeaths_policy", "cumulativedeaths_avoided" )
